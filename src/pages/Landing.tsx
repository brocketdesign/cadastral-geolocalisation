  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative overflow-hidden">
        ...
        <Floating y={20} duration={6} className="absolute top-20 left-[10%] w-72 h-72 bg-emerald-200/30 rounded-full blur-3xl pointer-events-none" >
          <div className="w-full h-full" />
        </Floating>
        <Floating y={15} duration={8} className="absolute bottom-10 right-[10%] w-60 h-60 bg-sky-200/30 rounded-full blur-3xl pointer-events-none" >
          <div className="w-full h-full" />
        </Floating>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-32">
          <div className="text-center max-w-4xl mx-auto">
            <motion.div
              ...
              className="inline-flex items-center gap-2 bg-emerald-100 text-emerald-800 px-4 py-1.5 rounded-full text-sm font-medium mb-6"
            >
      ...
      <section className="bg-slate-900 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <StaggerContainer stagger={0.15} className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {STATS.map((stat) => (
            ...
            {FEATURES.map((feature) => (
              <StaggerItem key={feature.title}>
                <motion.div whileHover={{ y: -6 }} transition={{ type: 'spring', stiffness: 300 }}>
                  <Card className="border-slate-200 hover:border-emerald-300 hover:shadow-lg transition-all duration-300 h-full">
      ...
      <section className="py-24 bg-gradient-to-br from-emerald-50 to-sky-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <StaggerContainer stagger={0.08} className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
            {[
              ...
              <StaggerItem key={territory.name}>
                <motion.div
                  whileHover={{ scale: 1.05, y: -4 }}
                  transition={{ type: 'spring', stiffness: 300 }}
                  className="bg-white rounded-xl p-5 shadow-sm hover:shadow-md transition-shadow text-center"
                >
                  <motion.div
      ...
      <section className="py-24 bg-gradient-to-r from-emerald-600 to-emerald-700 relative overflow-hidden">
        ...
        <div className="absolute top-0 left-0 w-96 h-96 bg-emerald-500/20 rounded-full -translate-x-1/2 -translate-y-1/2 blur-3xl" />
